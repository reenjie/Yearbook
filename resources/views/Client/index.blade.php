              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    @else
                    <button data-id="{{$item->id}}" data-type="ready" class="btnready btn btn-danger btn-sm w-100">Mark Order as Ready <i class="fas fa-circle"></i></button>
                    @endif
...
<script>
  $('.btnready').click(function() {
    ...
    swal({
        title: "Are you sure?",
        text: "Once Marked, you will not be able to undone it ",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      })
      .then((willDelete) => {
        if (willDelete) {
          ...
          $(this).html('Marking ...');
          window.location.href = "{{route('confirmOrder')}}?userid=" + id + "&type=" + type;
