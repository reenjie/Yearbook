...
-->
  <div class="logo">
    <p style="font-weight: bold;display:flex;font-size:12px">DPLMHS
    <h5 style="color:white">Year-Book</h5>
    </p>
...
<div class="modal  fade bd-example-modal-xl" data-backdrop="true" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl  " style="z-index:2000" role="document">
